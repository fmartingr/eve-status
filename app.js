...
(function() {
  var API_URL, DEBUG, LAST_INFO, XML_PATH, app, calculateTimeout, checkStatus, createTimeout, elementtree, express, https, moment, url;
  ...
  */
  ...
  checkStatus = function() {
    ...
    return https.request(requestOptions, function(response) {
      var data;
      data = '';
